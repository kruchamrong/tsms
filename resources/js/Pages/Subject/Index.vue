                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-[800px] w-full divide-y divide-gray-200 table-fixed">
                                <thead class="bg-gray-50">
                                    <tr>
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-40">លេខកូដ</th>
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">ឈ្មោះខ្មែរ</th>
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase w-64">ឈ្មោះអង់គ្លេស</th>
                                        <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase w-32">អក្សរកាត់</th>
                                        <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase w-24">ពណ៌</th>
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase w-24">សកម្មភាព</th>
                                    </tr>
                                </thead>
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr v-for="(subject, index) in localSubjects" :key="subject.id" 
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap flex items-center gap-2">
                                            ...
                                            <input type="text" v-model="subject.subject_code" @change="updateSubject(subject)" spellcheck="false" class="w-full border-0 rounded p-1 text-sm transition-colors bg-transparent hover:bg-black/5 focus:ring-1 focus:ring-blue-500">
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <input type="text" v-model="subject.khmer_name" @change="updateSubject(subject)" spellcheck="false" class="w-full border-0 rounded p-1 font-medium text-sm transition-colors bg-transparent hover:bg-black/5 focus:ring-1 focus:ring-blue-500 text-gray-900">
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <input type="text" v-model="subject.english_name" @change="updateSubject(subject)" spellcheck="false" class="w-full border-0 rounded p-1 text-sm transition-colors bg-transparent hover:bg-black/5 focus:ring-1 focus:ring-blue-500 text-gray-500">
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center justify-center border border-gray-200 p-0.5 rounded shadow-sm w-9 h-9 bg-white transition-colors mx-auto hover:border-gray-400">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <Link :href="route('subjects.destroy', subject.id)" method="delete" as="button" class="text-red-500 hover:text-red-700 p-2 rounded hover:bg-red-50 transition-colors" title="លុប">

...
const form = useForm({
    class_code: props.schoolClass.class_code,
    grade_id: props.schoolClass.grade_id,
    curriculum_id: props.schoolClass.curriculum_id || '',
    homeroom_teacher_id: props.schoolClass.homeroom_teacher_id || null,
    room_id: props.schoolClass.room_id || null,
    shift_id: props.schoolClass.shift_id || null,
    student_count: props.schoolClass.student_count,
});
...
<template>
    <Head title="កែប្រែថ្នាក់រៀន" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">កែប្រែថ្នាក់រៀន</h2>
        </template>
                    ...
                    <div class="p-6 text-gray-900">
                        <form @submit.prevent="submit" class="max-w-xl">
                            <div class="mb-4">
                                ...
                                <TextInput id="class_code" type="text" class="mt-1 block w-full" v-model="form.class_code" required />

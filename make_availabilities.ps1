...
Set-Content "app\Http\Controllers\TeacherAvailabilityController.php" $controllerTemplate
...
New-Item -ItemType Directory -Force -Path "resources\js\Pages\TeacherAvailability"
Set-Content "resources\js\Pages\TeacherAvailability\Index.vue" $vueTemplate
